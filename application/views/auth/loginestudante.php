               ...
               <div class="loginbox">
                  ...
                  <div class="login-right">
                     <div class="login-right-wrap">
                        ...
                        <form action="<?= base_url('auth/loginestudante') ?>" method="post">
                        ...
                        <div class="text-center dont-have">Seidauk iha akun? <a href="<?= base_url('auth/registuestudante')?>">Registu</a></div>
